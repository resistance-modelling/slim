...
xy_array = np.array([[186500,674500]]*nfarms)
...
bool_treat = '(delta_treat[farm-1]<0.005)'
					 
prob_arrive = pd.read_csv('./Data/props_med2.csv',header=None)
E_days = pd.read_csv('./Data/Edays.csv',header=None)
